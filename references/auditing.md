...
- Script audit: if skill retrieves data, calls APIs, or runs periodically — does it use scripts for heavy lifting rather than model logic? (references/script-patterns.md)
