...
- If the skill calls MCPs (Notion, Slack, Gmail, Calendar, Copilot) to retrieve data → Type A
...
JJ's skills for reference:
- Type A: morning-briefing, eod-sync, financial-advisor, meeting-review, github-security-audit
- Type B: negotiation-advisor, decision-filter, pitch-refiner, scenario-simulation
- Type C: linkedin-post, outreach-prep
- Type D: skill-installer, universal-skill-builder
